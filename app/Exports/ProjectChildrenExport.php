...
class ProjectChildrenExport implements FromCollection,WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
       ...
       $project_children = DB::table('sponsors')
        ...
        ->join('projects', 'projects.id', '=', 'sponsors.project_id')
            ->select('sponsors.*', 'sponsors.name as sname', 'children.resident','children._name','children.dob', 'projects.name as pname')
...
$mydata  = Collect([]);
        ...
        foreach ($project_children as $data){
      ...
      $resident = "No"; 
        ...
        $mydata->push(
            [   'Project Name' => $data->pname,
                ...
                'Name of Child' => $data->first_name.' '.$data->last_name,
                'Age' => $diff->format('%y'),
